...
if exist(fullfile(matlabroot,'toolbox','vision','vision','detectSURFFeatures.m'),'file') % Mathworks implementation
    ...
    if ispc || (isunix&&~ismac)
        ...
        error('iat_surf: appropriate version of Mathworks Computer Vision Toolbox is not installed. Execution of original implementation is possible in Windows or Linux platform');
    end
